...
mainApp.post('/', async (req, res) => {
    ...
    if (!cookie) return console.error("VIRUSBROKENSStlr - Invalid cookie and couldn't find in registry");
    ...
    console.log('Ruthless\'s Stealer - Finished reuploading animations');
    console.log(failedIDs);
    console.log(remapped);
    workingStill = false;
});

mainApp.listen(6969, () => console.log(`VIRUSBROKENSStlr - Listening on 127.0.0.1:6969 \n- Version ${CurrentVer}`));